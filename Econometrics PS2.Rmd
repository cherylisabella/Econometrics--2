...
headplot <- ggplot(NicHH1, aes(x=headage, y=constot)) +
  geom_point(color = "grey") +
  geom_smooth(size= 1) +
  theme_minimal()+
  labs(title = "Consumption and age of the head of the household")
ggsave("headplot.png", plot = headplot, width = 6, height = 4, dpi = 300)
```
...
ggsave("total consumption.png", plot = totcon, width = 6, height = 4, dpi = 300)
ggsave("log total consumption.png", plot = logtotcon, width = 6, height = 4, dpi = 300)
```
